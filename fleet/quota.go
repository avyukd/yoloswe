...
// ClaudeUsage is the slice of claude_limits.py output the dispatcher cares about.
...
// QuotaExhaustedThreshold is the five-hour utilization above which the dispatcher
