...
// A marked GitHub outage is exempt on its own authority, without the text
// having to look transient.
//
// This is the inverse of the CommandRoundError case above: there the marker
// SUPPRESSES a text match, here it SUPPLIES one the text cannot. GitHub's
